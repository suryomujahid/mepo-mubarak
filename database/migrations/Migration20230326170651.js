...
class Migration20230326170651 extends Migration {
  ...
  async up() {
    ...
    this.addSql('create table `guild_notification` (`id` text not null, `channel_id` text not null, `daily_hadith` integer not null default false, `created_at` datetime not null, primary key (`id`));');

    this.addSql('create table `hadith_rawi` (`id` text not null, `available` integer not null, `created_at` datetime not null, `updated_at` datetime not null, primary key (`id`));');
...
exports.Migration20230326170651 = Migration20230326170651;
